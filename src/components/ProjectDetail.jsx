  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/Abdullahbadres",
      }
      setProject(enhancedProject)
      document.title = `${enhancedProject.Title} | Abdullah Badres`
    } else {
      setProject(null)
      document.title = "Project Not Found | Abdullah Badres"
    }
  }, [id])
    ...
    return (
      <div className="min-h-screen bg-[#030014] flex items-center justify-center px-4">
        <div className="text-center space-y-6">
          ...
          <p className="text-gray-400">This project does not exist or may have been removed.</p>
          <button
            onClick={() => navigate("/")}
            className="px-6 py-3 rounded-xl bg-gradient-to-r from-blue-600/20 to-purple-600/20 text-blue-300 border border-blue-500/30"
          >
            Back to Home
          </button>
        </div>
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                {project.Link ? (
                  ...
                  <span className="inline-flex items-center px-4 md:px-8 py-2.5 md:py-4 text-sm md:text-base text-gray-500">
                    Demo Not Available
                  </span>
                )}
