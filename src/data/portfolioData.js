...
export const projectData = [
  ...
  },
  {
    ...
    Description:
      "Full-stack AI Sales Page Generator deployed on Azure with separate frontend, backend, and managed PostgreSQL database services.",
    Img: "https://placehold.co/600x340/0f172a/ffffff?text=AI+Sales+Page+Generator",
    Link: "http://testiso01333736.southeastasia.azurecontainer.io:3000",
    TechStack: [
      "React",
      "Vite",
      "Tailwind CSS",
    ...
    Features: [
      ...
      "Deployed frontend on Azure endpoint (:3000)",
      "Deployed backend API on Azure endpoint (:8080)",
      "Managed PostgreSQL database on Azure",
